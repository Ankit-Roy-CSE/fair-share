...
interface ParticipantSelectorProps {
    ...
    onParticipantsChange: (participants: ShortUser[]) => void;
}

export function ParticipantSelector({ participants, onParticipantsChange }: ParticipantSelectorProps) {
  ...
  // Search for users
  const searchData : any = useDBQuery(
    api.users.searchUsers,
    { query: searchQuery }
  );

  const searchResults : ShortUser[] = searchData?.data || [];
  const isLoading : boolean = searchData.isLoading;

  // Add a participant
  const addParticipant = (user : ShortUser) => {
