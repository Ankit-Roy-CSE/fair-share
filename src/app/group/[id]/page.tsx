...
import { GroupExpenseInfo } from "@/types";
...
export default function GroupExpensesPage() {
  ...
  const GroupExpenseData : any = useDBQuery(api.grpExpenses.getGroupExpenses, {groupId: params.id,});

  const data : GroupExpenseInfo = GroupExpenseData.data;
  const isLoading : boolean = GroupExpenseData.isLoading || !data;
