...
import { PersonalExpenseInfo } from "@/types";
...
export default function PersonExpensesPage() {
  ...
  const PersonalExpenseData : any = useDBQuery(api.expenses.getExpensesBetweenUsers,{ userId: params.id });
  const data : PersonalExpenseInfo = PersonalExpenseData.data;
  const isLoading : boolean = PersonalExpenseData.isLoading || !data;
